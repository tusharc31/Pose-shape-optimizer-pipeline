function [wireframe_collection, def_vectors_collection, rotation_collection, translation_collection] = pose_optimization(seq, frm, id)
...
observation_wts = kp_weights(seq, frm, id);
