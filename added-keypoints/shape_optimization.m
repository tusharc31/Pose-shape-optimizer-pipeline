function wireframe_collection = shape_optimization(seq, frm, id)
...
avgCarWidth = 1.6362;
avgCarHeight = 1.5208;
B = mobili_formula(seq, frm, id);
carCenters = B(:,4:6);
[wireframe, def_vectors] = frame_alignment(seq, frm, id);
[wireframe_temp, def_vectors_temp, rotation_collection, translation_collection] = pose_optimization(seq, frm, id);
observation_wts = kp_weights_combined(seq, frm, id);
[wkps, keypoints_collection] = keypoints(seq, frm, id);
